...
$interogare='insert into note values (';
$interogare.=$_POST['id'].",";
$interogare.="'".$_POST['disciplina']."',";
$interogare.="'".$_POST['semestru']."',";
$interogare.="'".$_POST['nota']."',";
...
<body>
<h1 align='center'>Adăugare notă</h1>
<div id='unu'>
<form method='post' action='Adaugare_nota.php' align='center'>
...
NOTA:<input type='text' name='nota'><br> <br> <br>
